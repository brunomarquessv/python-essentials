...
r = Rabbit(5) # adiciona 5 no self.age da classe pai (Animal)
# print(r)
# r.speak() # invoca o método speak da classe Rabbit
# r.set_name('fluffy') # set da classe pai (Animal) - onde adiciona fluffy a seu nome
# print(r)
