...
class Circle(object):
    def __init__(self, center, radius):
        if type(center) != Coordinate and type(radius) != int: # added code
            raise ValueError
        self.center = center
        self.radius = radius
...
# p = Coordinate(1,1)
# print(my_circle.is_inside(p)) # return true

# p = Coordinate(10,10)
# print(my_circle.is_inside(p)) # return false
...
# print(f1.times(f2))
print(f1.plus(f2)) # o f2 está como parametro por conta do other que recebe os valores de f2 
# print(f1.divide(f2))
# print(f1.minus(f2))
